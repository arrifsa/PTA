...
//End SIGNATURE
    ...
    //Convert Data Colors Desimal ke Biner

    //nilai b untuk sublockbit
    $b=8;
    //Sublock bit
...
//-------------------------------------------------------------------------------
    // DEKRIPSI
        ...
        //Sublock Bit Biner ke Desimal
    
        //Tampilkan PlainingImage
    ...
    $msg0 = "<div class='alert alert-danger'>Maaf Kamu Tanda Tangan Belum Dilengkapi</div>";
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block position-relative">
                                <img src="img/Background.png" width="100%" height="75%" class="cover">
                            </div>
                        <!--Form Registrasi-->
                        <div class="row mt-5 mb-5 col-xl-5 col-lg-5 col-md-4">
